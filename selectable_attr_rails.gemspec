...
Gem::Specification.new do |s|
  ...
  s.files = ["VERSION.yml", "lib/selectable_attr_i18n.rb", "lib/selectable_attr_rails", "lib/selectable_attr_rails/db_loadable.rb", "lib/selectable_attr_rails/helpers", "lib/selectable_attr_rails/helpers/abstract_selection_helper.rb", "lib/selectable_attr_rails/helpers/check_box_group_helper.rb", "lib/selectable_attr_rails/helpers/radio_button_group_helper.rb", "lib/selectable_attr_rails/helpers/select_helper.rb", "lib/selectable_attr_rails/helpers.rb", "lib/selectable_attr_rails/version.rb", "lib/selectable_attr_rails.rb", "spec/database.yml", "spec/debug.log", "spec/fixtures", "spec/introduction_spec.rb", "spec/schema.rb", "spec/selectable_attr_i18n_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<akm-selectable_attr>, [">= 0.3.1"])
    else
      s.add_dependency(%q<akm-selectable_attr>, [">= 0.3.1"])
    end
  else
    s.add_dependency(%q<akm-selectable_attr>, [">= 0.3.1"])
  end
